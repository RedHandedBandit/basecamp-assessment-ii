...
// CODE HERE
var myFriends = ["litch","dallin","justin","ian"];
/**
 * #6
 *
...
var myArrayCopy = myArray.map(function(el) {
  return el;
});
...
function evensOnly() {
  let arr3 = myNumbers.filter (e => e % 2 === 0)
  return arr3;
 }
...
var trueFriends = peopleIknow.filter(function(n) {
